...
namespace DataAccess.Configuration
{
    public class CekSenetBordroConfiguration : IEntityTypeConfiguration<CekSenetBordro>
    {
        public void Configure(EntityTypeBuilder<CekSenetBordro> builder)
        {
            ...
            builder.HasOne(a => a.CariHareket).WithOne().HasForeignKey<CekSenetBordro>(c => c.Id).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("CariHareket_1_1o0_KiymetliEvrakBordro");
        }
    }
}